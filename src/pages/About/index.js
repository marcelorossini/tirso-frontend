        ...
        <div className={'about '+( props.isPage ? 'page': '' )}>     
            <div> 
                <div className="text">
                    ...
                    <p>
                        Temos o objetivo de proporcionar aos alunos um treinamento virtual em um ambiente real de oficina, para que possa executar os serviços de forma prática, fácil e segura tanto ao técnico, quanto ao cliente. Com o aquecimento da economia, há mais vendas de motos novas, com a "crise" a maior vendas de motos usadas, em todas as opções é necessário uma demanda de profissionais nessa área de mecânica de motos.
                    </p>
                    <br/>
